...
public class US023 {
    ...
    RecepPage invoice = new RecepPage();
    ...
    invoice.usernameBox.sendKeys(ConfigReader.getProperty("patientUsername1"));
    invoice.passwordBox.sendKeys(ConfigReader.getProperty("patientPassword1"));
    ...
    invoice.accountMenu.click();
    invoice.accountSignIn.click();
    invoice.usernameBox.sendKeys(ConfigReader.getProperty("staffUsername"));
    invoice.passwordBox.sendKeys(ConfigReader.getProperty("staffPassword"));
    invoice.submitSignIn.click();
    waitFor(2);
    }
    ...
    invoice.accountMenu.click();
    invoice.accountSignIn.click();
    invoice.usernameBox.sendKeys(ConfigReader.getProperty("doctorUsername"));
    invoice.passwordBox.sendKeys(ConfigReader.getProperty("doctorPassword"));
    invoice.submitSignIn.click();
    waitFor(2);
    }
